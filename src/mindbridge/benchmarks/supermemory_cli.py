...
class SuperMemoryRunManifest(MediaRunManifest):
...
def _select_questions(
    ...
    selected = select_by_id(
        ...
        label=f"SuperMemory-VQA subject {subject} question",
    )
    if not selected:
...
def _parse_arguments() -> _Arguments:
    parser = benchmark_parser(tenant_prefix="benchmark_supermemory")
    add_media_arguments(parser, device_id="supermemory_glasses")
