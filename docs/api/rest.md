...
The five modality lists are the declarations routing reads, sorted for a stable document; an empty
...
| `search_with_trace` | Retrieval diagnostics with no client action |
...
| `reinforce` | No route; has an MCP tool |
