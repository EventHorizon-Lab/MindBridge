...
| `ContextBudgetRequest` | `max_chars=6000`; `max_items=24`; `min_confidence=0.0`; optional `memory_types` with at least one value; optional `freshness_seconds`; optional `max_latency_ms` |
